                            ...
                            <form  action="#" method="POST">
                                <?php if($RoleId == 1){ ?>
                                    ...
                                    <?php foreach ($dataset_schoolall as $key => $sc){ ?>
                                        <option value="<?php echo $sc->school_id; ?>" <?php if($sc->school_id == $school_id){ echo "Selected"; } ?>><?php //echo $sc->school_id; ?><?php echo $sc->schoolname; ?></option>
                                    <?php } ?>
                                    </select>
                                <?php } ?>
                                <select id="year_id" name="year_id" onchange="get_year(this.value)" style="width: 120px;">
                                    <?php foreach ($dataset_yearall as $key => $yr){ ?>
                                    <option value="<?php echo $yr->YearId; ?>" <?php if(isset($year_id)){if($yr->YearId == $year_id){ echo "Selected"; }}else{if($yr->YearId == $dataset_y->YearId){ echo "Selected"; }} ?> ><?php //echo $yr->YearId.'nn'; ?><?php echo $yr->YEAR; ?></option>
                                    <?php } ?>
                                </select>
                            </form>
                        </li>
                ...
                <div class="mb-middle">
                    ...
                    <div class="mb-footer">
                        <div class="pull-right">
                            <a href="{{ url('doLogout') }}" class="btn btn-default btn-lg">Yes</a>
