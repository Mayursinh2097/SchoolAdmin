...
@section('content')
    ...
    <div class="page-content-wrap">     
        <div class="row">
                ...
                <form id="add_role_form" class="form-horizontal" enctype="multipart/form-data" >
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Add Division</strong> </h3>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">                                
                        <h3 class="panel-title"><strong>View Division</strong> </h3>
                    ...
                    <div class="panel-body">
                        <table class="table datatable">
                            ...
                            <?php 
                                $i = 1;
                                foreach ($division as $key => $dv)
                                {
                            ?>
                                <tr class="odd gradeX" >
                                    <td class="center"> <?php echo $i;?></td>
                                    <td class="center"> <?php echo $dv->ClassName;?></td>
                                    <td class="center"> <?php echo $dv->DivisionName;?></td>
                                    <td class="center">
                                        <a href="{{url('division/'.$dv->DivisionId.'/edit')}}" class="btn btn-primary btn-rounded" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;

                                        <a  onclick="deleteDivision('{{$dv->DivisionId}}');" class="btn btn-primary btn-rounded" name="delete" id="delete" title="Delete"><i class="fa fa-trash-o"></i></a>
        ...
        <div class="mb-container">
            <div class="mb-middle">
                ...
                <div class="mb-content">
                    <p style="font-size: 15px;">Division added successfully.</p>
                </div>
    ...
    <div class="message-box message-box-danger animated fadeIn" id="message-box-danger123">
        <div class="mb-container">
            <div class="mb-middle">
                <div class="mb-title"><span class="fa fa-times"></span>Error</div>
                <div class="mb-content">
                    <p style="font-size: 15px;"> Division already inserted.</p>
                </div>
                <div class="mb-footer"></div>
            </div>
        </div>
    ...
    <div class="message-box message-box-danger animated fadeIn" id="message-box-danger">
        <div class="mb-container">
            <div class="mb-middle">
                ...
                <div class="mb-content">
                    <p style="font-size: 15px;"> Division deleted successfully.</p>
                </div>
                <div class="mb-footer"></div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        {
            var checkstr =  confirm('Are you sure you want to delete Division ?');
            if(checkstr == true){
                $.ajax({
                    url: "{{ url('/deletedivision') }}",
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $("input[name='_token']").val()
                    },
