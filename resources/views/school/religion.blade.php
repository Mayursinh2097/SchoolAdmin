...
@section('content')
    ...
    <div class="page-content-wrap">     
        <div class="row">
                ...
                <form id="add_role_form" class="form-horizontal" enctype="multipart/form-data" >
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Add Religion</strong> </h3>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">                                
                        <h3 class="panel-title"><strong>View Religion</strong> </h3>
                        ...
                        <table class="table datatable">
                            ...
                            ?>
                                <tr class="odd gradeX" >
                                    ...
                                    <td class="center"> <?php echo $rg->ReligionName;?></td>
                                    <td class="center">
                                        <a href="{{url('religion/'.$rg->ReligionId.'/edit')}}" class="btn btn-primary btn-rounded" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;

                                        <a  onclick="deleteReligion('{{$rg->ReligionId}}');" class="btn btn-primary btn-rounded" name="delete" id="delete" title="Delete"><i class="fa fa-trash-o"></i></a>
        ...
        <div class="mb-container">
            <div class="mb-middle">
                ...
                <div class="mb-content">
                    <p>Religion added successfully.</p>
                </div>
                <div class="mb-footer">
    ...
    <div class="message-box message-box-danger animated fadeIn" id="message-box-danger">
        <div class="mb-container">
            <div class="mb-middle">
                ...
                <div class="mb-content">
                    <p>Religion deleted successfully.</p>
                </div>
                <div class="mb-footer">
                    <!-- <button class="btn btn-default btn-lg pull-right mb-control-close">Close</button> -->
                </div>
    ...
    <script type="text/javascript">
        ...
        {
            var checkstr =  confirm('Are you sure you want to delete Religion ?');
            if(checkstr == true){
                $.ajax({
                    url: "{{ url('/deletereligion') }}",
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $("input[name='_token']").val()
                    },
