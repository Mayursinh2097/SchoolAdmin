...
@section('content')
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Student LC</strong> </h3>
                        </div>
    ...
    <!-- ALERT BOX -->
         <div class="message-box message-box-danger animated fadeIn" id="message-box-alert">
            <div class="mb-container">
                <div class="mb-middle">
                    <div class="mb-title"><span class="fa fa-trash-o"></span> Are You Sure ??</div>
    ...
    <script type="text/javascript">
        ...
        function get_stu_data(class_id, div_id, school_id, year_id)
        {
            ...
            $.ajax({
                url: "{{ url('student/getStudentsList') }}",
                method: 'get',
                dataType: 'json',
                    ...
                    if(response.success == 0)
                    {
                        ...
                        for(var i=0; i<response.data.length; i++)
                        {
                            ...
                            if (RoleId != 2) {
                                ...
                                html_data += '<a id="lcID'+response.data[i].StudentId+'" class="btn btn-primary btn-rounded" title="Assign LC"><i class="fa fa-edit" onclick="updateLC('+response.data[i].StudentId+','+response.data[i].Current_Class+','+"'"+response.data[i].StudentName+"'"+')"></i></a></td>';
        ...
        function  updateLC(stuId,stuClass,name)
        {

            var yes = confirm("Are You Sure!");
            if (yes == true) {
                 var url = "{{url('student/addStudentLC')}}/Id="+stuId+'&CL='+stuClass+'&StuName='+name;
